...
- `fusion-addin/VolumindAI/` — תוסף Fusion 360 גרסה 3.2 עם API מקומי וחיבור מלא לטלפון.
...
קוד הצימוד מוצג בתוך `הגדרות` בתוסף Fusion, ומחבר Windows קורא אותו אוטומטית. הקוד נשמר במחשב ואינו משתנה בכל פתיחה של Fusion. נורת החיבור בהגדרות נעשית ירוקה כאשר אפליקציית Android מחוברת בפועל.
